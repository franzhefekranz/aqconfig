...
#  Nov 04, 2020 02:02:50 PM CET  platform: Windows NT
set vTcl(timestamp) ""
...
proc vTclWindow.top45 {base} {
    ...
    wm geometry $top 300x220+660+210
    update
    # set in toplevel.wgt.
    global vTcl
    global img_list
    ...
    bind $top.tBu49 <ButtonRelease-1> {
        lambda e: btnPathToExe_LeftRelease(e)
    }
    ttk::label $top.tLa50 \
        -background $vTcl(actual_gui_bg) -foreground $vTcl(actual_gui_fg) \
        -font TkDefaultFont -relief sunken -anchor w -justify left \
        -textvariable strPathToAqserver 
    vTcl:DefineAlias "$top.tLa50" "lblPathToExe" vTcl:WidgetProc "frmGetLang" 1
    ###################
    # SETTING GEOMETRY
    ###################
    place $top.tBu47 \
    ...
    place $top.tBu49 \
        ...
        -anchor nw -bordermode ignore 
    place $top.tLa50 \
        -in $top -x 10 -y 40 -width 280 -relwidth 0 -height 25 -relheight 0 \
        -anchor nw -bordermode ignore 
